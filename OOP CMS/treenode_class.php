<?php>
	...
	class treenode{
		...
		public function __constuct($postid, $title, $poster, $posted, $children, $expand, $depth, $sublist) {
			...
			//has children and is marked expanded
		...
		function display($row, $sublist = false) {
			...
			if($this->m_depth>-1) {
				...
				echo "<a name=\"".$this->m_postid."\"><a href=\"view_post.php?postid=".$this->m_poster." - ".
