<?php
	...
	{
    	//mark all threads with children to be shown
		$conn = db_connect();
	...
	function get_post($postid)
	{
		...
		//get message from body and add it to previous result
	...
	function get_post_title($postid)
	{
		...
		//get header information from 'header'
	...
	{
		//add a quoting pattern to mark text quoted on your reply
	...
	//that are the same except for an id and probably posted time
